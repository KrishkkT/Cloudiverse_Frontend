...
const CostBreakdown = ({ services, currency = 'USD' }) => {
    ...
    // Helper to extract monthly cost from either shape
    const getMonthly = (s) => {
    ...
    //                                 </div>
    //                                 <div>
    //                                     <div className="text-sm font-medium text-gray-200">{service.cloud_service || service.display_name || service.name || service.generic_name}</div>
    //                                     <div className="text-[10px] text-gray-500">{service.display_name || service.generic_name || service.name} • {service.category || 'Infrastructure'}</div>
    ...
    //                                         {((getMonthly(service) / totals.PRICED) * 100).toFixed(0)}%
    //                                     </div>
    //                                 )}
    //                             </div>
    //                         </div>
