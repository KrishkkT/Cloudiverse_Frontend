        ...
        <AnimatePresence>
            {showPopup && (
                <>
                    ...
                    />
                    <motion.div
                        initial={{ opacity: 0, scale: 0.95, y: 10, x: "-50%", top: "50%" }}
                        animate={{ opacity: 1, scale: 1, y: "-50%" }}
                        exit={{ opacity: 0, scale: 0.95, y: 10 }}
                        transition={{ duration: 0.2 }}
                        className="fixed left-1/2 top-1/2 w-[90vw] max-w-md bg-surface border border-border rounded-xl shadow-2xl p-6 z-[10000] overflow-hidden"
                        role="dialog"
                        aria-modal="true"
                    >
                        {/* Close Button */}
